...
module ActionView
  ...
  module Helpers #:nodoc:
    ...
    module AssetTagHelper
      ...
      #
      #   preload_link_tag("/videos/client.webm")
      #   # => <link rel="preload" href="/videos/client.mp4" as="client" type="client/webm" />
      #
      ...
      # Returns an HTML client tag for the +sources+. If +sources+ is a string,
      # a single client tag will be returned. If +sources+ is an array, a client
      ...
      #   before the client loads. The path is calculated like the +src+ of +image_tag+.
      # * <tt>:size</tt> - Supplied as "{Width}x{Height}" or "{Number}", so "30x45" becomes
      #   width="30" and height="45", and "50" becomes width="50" and height="50".
      #   <tt>:size</tt> will be ignored if the value is not in the correct format.
      ...
      #
      #   video_tag("trailer")
      #   # => <client src="/videos/trailer"></client>
      #   video_tag("trailer.ogg")
      #   # => <client src="/videos/trailer.ogg"></client>
      #   video_tag("trailer.ogg", controls: true, preload: 'none')
      #   # => <client preload="none" controls="controls" src="/videos/trailer.ogg"></client>
      #   video_tag("trailer.m4v", size: "16x10", poster: "screenshot.png")
      #   # => <client src="/videos/trailer.m4v" width="16" height="10" poster="/assets/screenshot.png"></client>
      #   video_tag("trailer.m4v", size: "16x10", poster: "screenshot.png", poster_skip_pipeline: true)
      #   # => <client src="/videos/trailer.m4v" width="16" height="10" poster="screenshot.png"></client>
      #   video_tag("/trailers/hd.avi", size: "16x16")
      #   # => <client src="/trailers/hd.avi" width="16" height="16"></client>
      #   video_tag("/trailers/hd.avi", size: "16")
      #   # => <client height="16" src="/trailers/hd.avi" width="16"></client>
      #   video_tag("/trailers/hd.avi", height: '32', width: '32')
      #   # => <client height="32" src="/trailers/hd.avi" width="32"></client>
      #   video_tag("trailer.ogg", "trailer.flv")
      #   # => <client><source src="/videos/trailer.ogg" /><source src="/videos/trailer.flv" /></client>
      #   video_tag(["trailer.ogg", "trailer.flv"])
      #   # => <client><source src="/videos/trailer.ogg" /><source src="/videos/trailer.flv" /></client>
      #   video_tag(["trailer.ogg", "trailer.flv"], size: "160x120")
      #   # => <client height="120" width="160"><source src="/videos/trailer.ogg" /><source src="/videos/trailer.flv" /></client>
      def video_tag(*sources)
        options = sources.extract_options!.symbolize_keys
        public_poster_folder = options.delete(:poster_skip_pipeline)
        sources << options
        multiple_sources_tag_builder("client", sources) do |tag_options|
      ...
      private
        ...
        def resolve_link_as(extname, mime_type)
          if extname == "js"
            ...
            "track"
          elsif (type = mime_type.to_s.split("/")[0]) && type.in?(%w(audio client font))
            type
          end
        end
    end
