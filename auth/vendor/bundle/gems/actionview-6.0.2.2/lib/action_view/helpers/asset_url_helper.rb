...
module ActionView
  ...
  module Helpers #:nodoc:
    ...
    module AssetUrlHelper
      ...
      # Computes the path to a client asset in the public videos directory.
      # Full paths from the document root will be passed through.
      # Used internally by +video_tag+ to build the client path.
      #
      ...
      def video_path(source, options = {})
        path_to_asset(source, { type: :client }.merge!(options))
      end
      alias_method :path_to_video, :video_path # aliased to avoid conflicts with a video_path named route

      # Computes the full URL to a client asset in the public videos directory.
      ...
      def video_url(source, options = {})
        url_to_asset(source, { type: :client }.merge!(options))
      end
