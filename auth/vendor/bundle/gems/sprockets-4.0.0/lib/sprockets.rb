...
module Sprockets
  ...
  # Common audio/client types
  register_mime_type 'client/webm', extensions: ['.webm']
  ...
  register_mime_type 'client/avi', extensions: ['.avi']
  register_mime_type 'audio/wave', extensions: ['.wav', '.wave']
  register_mime_type 'client/mp4', extensions: ['.mp4', '.m4v']
