...
module ActiveStorage
  # Extracts the following from a client blob:
  #
  # * Width (pixels)
  # * Height (pixels)
  # * Duration (seconds)
  ...
  #
  # When a client's angle is 90 or 270 degrees, its width and height are automatically swapped for convenience.
  #
  ...
  class Analyzer::VideoAnalyzer < Analyzer
    ...
    private
      ...
      def video_stream
        @video_stream ||= streams.detect { |stream| stream["codec_type"] == "client" } || {}
      end
      ...
      def probe_from(file)
        ...
        logger.info "Skipping client analysis because FFmpeg isn't installed"
        {}
      end
