...
module ActiveStorage::Blob::Representable
  ...
  # from a non-image blob. Active Storage comes with built-in previewers for videos and PDF documents. The client previewer
  # extracts the first frame from a client and the PDF previewer extracts the first page from a PDF document.
  #
  ...
  #
  #   <%= image_tag client.preview(resize_to_limit: [100, 100]) %>
  #
