...
# Some non-image blobs can be previewed: that is, they can be presented as images. A client blob can be previewed by
...
#
# The built-in previewers rely on third-party system libraries. Specifically, the built-in client previewer requires
