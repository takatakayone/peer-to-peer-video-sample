...
class MimeMagic
  ...
  EXTENSIONS = {
    ...
    'avf' => 'client/x-msvideo',
    'avi' => 'client/x-msvideo',
    ...
    'gvp' => 'text/x-google-client-pointer',
    'gz' => 'application/gzip',
    'h' => 'text/x-chdr',
    'h++' => 'text/x-c++hdr',
    ...
    'mj2' => 'client/mj2',
    'mjp2' => 'client/mj2',
    'mjpeg' => 'client/x-mjpeg',
    'mjpg' => 'client/x-mjpeg',
    'mjs' => 'application/javascript',
    'mk' => 'text/x-makefile',
    'mk3d' => 'client/x-matroska-3d',
    'mka' => 'audio/x-matroska',
    'mkd' => 'text/markdown',
    'mkv' => 'client/x-matroska',
    'ml' => 'text/x-ocaml',
    'mli' => 'text/x-ocaml',
    'mm' => 'text/x-troff-mm',
    ...
    'mod' => 'audio/x-mod',
    'mof' => 'text/x-mof',
    'moov' => 'client/quicktime',
    'mount' => 'text/x-systemd-unit',
    'mov' => 'client/quicktime',
    'movie' => 'client/x-sgi-movie',
    'mp+' => 'audio/x-musepack',
    'mp2' => 'audio/mp2',
    'mp3' => 'audio/mpeg',
    'mp4' => 'client/mp4',
    ...
    'rtf' => 'application/rtf',
    'rtx' => 'text/richtext',
    'rv' => 'client/vnd.rn-realvideo',
    'rvx' => 'client/vnd.rn-realvideo',
  ...
  TYPES = {
    ...
    'application/mxf' => [%w(mxf), %w(), 'MXF client'],
    ...
    'application/vnd.ms-asf' => [%w(asf), %w(), 'ASF client'],
    ...
    'application/x-quicktime-media-link' => [%w(qtl), %w(client/quicktime), 'QuickTime metalink playlist'],
    ...
    'audio/x-m4r' => [%w(m4r), %w(client/mp4), 'MPEG-4 Ringtone'],
    ...
    'text/x-google-client-pointer' => [%w(gvp), %w(), 'Google Video Pointer'],
    ...
    'client/3gpp' => [%w(3ga 3gp 3gpp), %w(client/mp4), '3GPP multimedia file'],
    'client/3gpp2' => [%w(3g2 3gp2 3gpp2), %w(client/mp4), '3GPP2 multimedia file'],
    'client/annodex' => [%w(axv), %w(application/annodex), 'Annodex Video'],
    'client/dv' => [%w(dv), %w(), 'DV client'],
    'client/mj2' => [%w(mj2 mjp2), %w(), 'JPEG-2000 MJ2 client'],
    'client/mp2t' => [%w(bdm bdmv clpi cpi m2t m2ts mpl mpls mts ts), %w(), 'MPEG-2 transport stream'],
    'client/mp4' => [%w(f4v lrv m4v mp4), %w(), 'MPEG-4 client'],
    'client/mpeg' => [%w(mp2 mpe mpeg mpg vob), %w(), 'MPEG client'],
    'client/ogg' => [%w(ogg ogv), %w(application/ogg), 'Ogg Video'],
    'client/quicktime' => [%w(moov mov qt qtvr), %w(), 'QuickTime client'],
    'client/vnd.mpegurl' => [%w(m1u m4u mxu), %w(text/plain), 'MPEG client (streamed)'],
    'client/vnd.rn-realvideo' => [%w(rv rvx), %w(), 'RealVideo document'],
    'client/vnd.vivo' => [%w(viv vivo), %w(), 'Vivo client'],
    'client/webm' => [%w(webm), %w(), 'WebM client'],
    'client/x-flic' => [%w(flc fli), %w(), 'FLIC animation'],
    'client/x-flv' => [%w(flv), %w(), 'Flash client'],
    'client/x-javafx' => [%w(fxm), %w(client/x-flv), 'JavaFX client'],
    'client/x-matroska' => [%w(mkv), %w(application/x-matroska), 'Matroska client'],
    'client/x-matroska-3d' => [%w(mk3d), %w(application/x-matroska), 'Matroska 3D client'],
    'client/x-mjpeg' => [%w(mjpeg mjpg), %w(image/jpeg), 'MJPEG client stream'],
    'client/x-mng' => [%w(mng), %w(), 'MNG animation'],
    'client/x-ms-wmv' => [%w(wmv), %w(application/vnd.ms-asf), 'Windows Media client'],
    'client/x-msvideo' => [%w(avf avi divx), %w(), 'AVI client'],
    'client/x-nsv' => [%w(nsv), %w(), 'NullSoft client'],
    'client/x-ogm+ogg' => [%w(ogm), %w(client/ogg), 'OGM client'],
    'client/x-sgi-movie' => [%w(movie), %w(), 'SGI client'],
    'client/x-theora+ogg' => [%w(ogg), %w(client/ogg), 'Ogg Theora client'],
  ...
  MAGIC = [
    ...
    ['client/x-msvideo', [[0, 'RIFF', [[8, 'AVI ']]], [0, 'AVF0', [[8, 'AVI ']]]]],
    ['client/mp4', [[4, 'ftypisom'], [4, 'ftypmp42'], [4, 'ftypMSNV'], [4, 'ftypM4V '], [4, 'ftypf4v ']]],
    ['client/quicktime', [[12, 'mdat'], [4, 'mdat'], [4, 'moov'], [4, 'ftypqt']]],
    ['client/mpeg', [[0, "G?\377\020"], [0, "\000\000\001\263"], [0, "\000\000\001\272"]]],
    ['client/ogg', [[0, 'OggS']]],
    ['client/webm', [[0, "\032E\337\243", [[5..65, "B\202", [[8..75, 'webm']]]]]]],
    ['client/x-flv', [[0, 'FLV']]],
    ...
    ['client/x-ogm+ogg', [[0, 'OggS', [[29, 'client']]]]],
    ['client/x-theora+ogg', [[0, 'OggS', [[28, "\200theora"]]]]],
    ...
    ['text/x-google-client-pointer', [[0, '#.download.the.free.Google.Video.Player'], [0, '# download the free Google Video Player']]],
    ...
    ['text/xmcd', [[0, '# xmcd']]],
    ['client/3gpp', [[4, 'ftyp3ge'], [4, 'ftyp3gg'], [4, 'ftyp3gp'], [4, 'ftyp3gs']]],
    ['client/3gpp2', [[4, 'ftyp3g2']]],
    ['client/annodex', [[0, 'OggS', [[28, "fishead\000", [[56..512, "CMML\000\000\000\000"]]]]]]],
    ['client/dv', []],
    ['client/mj2', []],
    ['client/mp2t', [[0, 'G', [[188, 'G', [[376, 'G', [[564, 'G', [[752, 'G']]]]]]]]], [4, 'G', [[196, 'G', [[388, 'G', [[580, 'G', [[772, 'G']]]]]]]]]]],
    ['client/vnd.mpegurl', [[0, '#EXTM4U']]],
    ['client/x-flic', [[0, "\021\257"], [0, "\022\257"]]],
    ['client/x-mng', [[0, "\212MNG\r\n\032\n"]]],
    ['client/x-nsv', [[0, 'NSVf']]],
    ['client/x-sgi-movie', [[0, 'MOVI']]],
